...
with open("src/services/text_analyzer/utils/id2topic.json") as f:
...
class BadThemeAnalyzer:
    ...
    def string_text_to_text(self, string):
        ...
        for line in string_list:
            ...
            if len(splitting) > 2:
                ...
                if preds != "none":
                    ...
                    new_str = (
                        f"{splitting[0]}:{splitting[1]}:{splitting[2]}:{splitting[3]}"
                    )
        ...
        return {"new_text": new_string, "bad_person": bad_person}
