from src.services.text_analyzer.scripts.parsing import read_file_txt


class RussianParazitWordDetect:
    def __init__(
        self, path_bad_word="src/services/text_analyzer/utils/russian_parazit.txt"
    ):
    ...
    def clear_file(self, filename):
        ...
        for line in string_list:
            ...
            if len(splitting) > 2:
                ...
                new_str = (
                    f"{splitting[0]}:{splitting[1]}:{splitting[2]}:{text_preprocc}"
                )
